...
export const ciudades: Ciudad[] = [
  ...
  { slug: 'marseille', nombre: 'Marseille', pais: 'France', lat: 43.2965, lon: 5.3698, foto: '/images/villes/marseille.svg' },
  { slug: 'bordeaux', nombre: 'Bordeaux', pais: 'France', lat: 44.8378, lon: -0.5792, foto: '/images/villes/bordeaux.svg' },
  { slug: 'nice', nombre: 'Nice', pais: 'France', lat: 43.7102, lon: 7.262, foto: '/images/villes/nice.svg' },
  { slug: 'strasbourg', nombre: 'Strasbourg', pais: 'France', lat: 48.5734, lon: 7.7521, foto: '/images/villes/strasbourg.svg' },
  { slug: 'londres', nombre: 'Londres', pais: 'Royaume-Uni', lat: 51.5074, lon: -0.1278, foto: '/images/villes/londres.svg' },
  { slug: 'berlin', nombre: 'Berlin', pais: 'Allemagne', lat: 52.52, lon: 13.405, foto: '/images/villes/berlin.svg' },
